    ...
    Indicator.prototype = {
        ...
        value: function (val) {
            ...
            if (indOption.displayNumber) {
                ...
                ctx.font = weight +" "+ fontSize*0.65 + "px " + cFont;
                ctx.textAlign = "center";
                ctx.textBaseline = 'middle';
                ctx.fillText(dispVal, center, center);
				
				ctx.font = weight +" "+ fontSize*0.247 + "px " + cFont;
				ctx.fillText(title,center,center*1.3);
            }
